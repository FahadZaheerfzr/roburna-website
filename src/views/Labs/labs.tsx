  ...
  return (
    <div className="blockchain">
      ...
      <div className="blockchain-tophalf labs-page">
        {!isUndefined(LABs) && (
          <section className="alt-banner d-flex align-items-center labs-banner">
            ...
            <div className='flex flex-col justify-center items-center text-center lg:w-[40%] px-10'>
              <img className="w-[30%] " src={labs} alt={labs} />
              <h2 className="px-5">{LABs.title}</h2>
              <div className="xl:text-[16px] lg:text-[12px]" dangerouslySetInnerHTML={{ __html: LABs.description }} />
        ...
        <section id="labs" className="mt-lg-5 p-md-5 pt-5 p-3 text-center flex flex-col justify-center items-center lg:block">
          ...
          <a href="https://roburnaforest.com/" >
            <button className="--btn-1 labs-btn1">
                  ...
                  {!isNull(project.project_link) ? (
                    ...
                    >
                      ...
                      project.project_link ===
                        "https://roburna-website.vercel.app/wallet-signup"
                        ? "Sign Up"
