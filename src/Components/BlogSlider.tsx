  ...
  useEffect(() => {
    const loadBlogs = async () => {
        try {
            ...
            // Filter out blogs with publish_at less than or equal to the current time
            ...
            filteredBlogs.forEach(blog => {
                blog.created_at = formatDateTime(blog.created_at);
            });
                ...
                blogs.map((blog, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <div
                        className="blog-card-bottom h-[400px] lg:h-[600px]"
