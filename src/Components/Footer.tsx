    ...
    <footer className="px-lg-5 pt-lg-5 px-md-2 pt-md-5">
      <div className="row">
        <div className="col-xl-2 col-md-6 footer-nav">
          ...
          <a href="https://rbascan.com/" target="_blank" className="nav-item nav-link mb-0">
            RBA SCAN
          </a>
          <NavLink
            to="/contact"
        ...
        <div className="col-md-3 footer-projects">
          ...
          <NavLink to="/labs">Roburna Army Bot</NavLink>
          <NavLink to="/labs">RobuPay</NavLink>
            <NavLink to="/blockchain" className="--btn-1 w-64">Visit Roadmap</NavLink>
          <div
            style={{
              display: "flex",
